...
{
    NSOrderedSet *orderedSet = [[[self class] allocWithZone:zone] initWithArray:[self array]];
    return orderedSet;
}

- (id)mutableCopyWithZone:(NSZone *)zone
{
    NSMutableOrderedSet *orderedSet = [[NSMutableOrderedSet allocWithZone:zone] initWithArray:[self array]];
    return orderedSet;
}
...
- (BOOL)isEqual:(id)object
{
    if([object isKindOfClass:[self class]]){
        NSOrderedSet *otherOrderedSet = (NSOrderedSet *)object;
...
+ (id)orderedSetWithOrderedSet:(NSOrderedSet *)nSet
{
    return [[NSOrderedSet alloc] initWithOrderedSet:nSet];
}

+ (id)orderedSetWithOrderedSet:(NSOrderedSet *)nSet range:(NSRange)range copyItems:(BOOL)flag
{
    return [[NSOrderedSet alloc] initWithOrderedSet:nSet
                                      range:range
                                  copyItems:flag];
...
- (id)initWithOrderedSet:(NSOrderedSet *)nSet
{
