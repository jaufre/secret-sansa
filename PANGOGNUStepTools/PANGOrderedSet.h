...
+ (id)orderedSetWithOrderedSet:(PANGOrderedSet *)set;
+ (id)orderedSetWithOrderedSet:(PANGOrderedSet *)set range:(NSRange)range copyItems:(BOOL)flag;
...
- (id)initWithOrderedSet:(PANGOrderedSet *)set;
- (id)initWithOrderedSet:(PANGOrderedSet *)set copyItems:(BOOL)flag;
- (id)initWithOrderedSet:(PANGOrderedSet *)set range:(NSRange)range copyItems:(BOOL)flag;
